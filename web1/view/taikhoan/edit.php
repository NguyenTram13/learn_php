            ...
            <div class="row boxcontent chitiet">
                <form action="index.php?act=edit_taikhoan" class="form_register" method="post">
                    ...
                    <div class="group">
                        ...
                        <input type="password" name="pass" value="<?= $pass ?>" id="pass" class="pass" placeholder="password...">
                    </div>
                    <div class="group">
                        <label for="user">Name User:</label>
                        <input type="text" name="user" value="<?= $user ?>" id="user" class="user" placeholder="nameuser...">
                    </div>
                    <div class="group">
